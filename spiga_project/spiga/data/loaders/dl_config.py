...
# Default data paths
db_img_path = pkg_resources.resource_filename('spiga_project.spiga', 'data/databases')
db_anns_path = pkg_resources.resource_filename('spiga_project.spiga', 'data/annotations') + "/{database}/{file_name}.json"
